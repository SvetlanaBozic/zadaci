class Zgrada {
    constructor(brojSpratova, visinaZgrade) {
    ...
    trebaLift(maxVisina, maxBrojSpratova) {
        let vrati = (this.visinaZgrade > maxVisina || this.brojSpratova > maxBrojSpratova) ? "Neophodno je ugraditi lift" : "Ne treba lift";
        return vrati;
    }
}
